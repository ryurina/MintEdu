    ...
    <main class="max-w-4xl mx-auto px-6 py-16">
      ...
      <div class="prose prose-lg max-w-none text-gray-700 space-y-8">
        ...
        <section>
          ...
          <p>
            MintEdu ("Company," "we," "our," or "us") is committed to protecting
          ...
          <div class="space-y-6">
            <div>
              ...
              <ul class="list-disc pl-6 space-y-2">
                <li>
                  ...
                  password, phone number, and profile information
                </li>
                <li>
                  <strong>Educational Information:</strong> School/university
                  name, program details, graduation date, and academic records
                </li>
                <li>
                  <strong>Financial Information:</strong> Bank account details,
                  payment methods, loan amounts, and investment preferences
                </li>
                <li>
                  <strong>Identity Verification:</strong> Government-issued ID,
                  date of birth, address, and SSN/tax ID for compliance
                </li>
                <li>
                  <strong>Communication:</strong> Messages, support tickets, and
            ...
            <div>
              ...
              <ul class="list-disc pl-6 space-y-2">
                ...
                <li>
                  ...
                  clicks, search queries, and interaction patterns
                </li>
                <li>
                ...
                <li>
                  <strong>Blockchain Data:</strong> Transaction history and
                  wallet addresses on the Hedera network
                </li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul class="list-disc pl-6 space-y-2">
                ...
                <li>
                  Financial institutions for identity and credit verification
                </li>
                <li>
                  Background check providers for compliance and fraud prevention
                </li>
                <li>Analytics providers and service partners</li>
              </ul>
            </div>
          </div>
        </section>
          ...
          <div class="space-y-6">
            <div>
              ...
              <p>
                ...
                perform services on our behalf, including payment processors,
                identity verification providers, and analytics services. These
            ...
            <div>
              ...
              <p>
                We may share information with educational institutions and
                financial partners necessary to facilitate loans and investments
                on our platform.
              </p>
            </div>
            ...
            <div>
              ...
              <p>
                ...
                or government authority, or when we believe in good faith that
            ...
            <div>
              ...
              <p>
                If MintEdu is involved in a merger, acquisition, bankruptcy, or
        ...
        <section>
          ...
          <ul class="list-disc pl-6 space-y-2 mt-4">
            ...
            <li>
              Secure authentication mechanisms including multi-factor
              authentication
            </li>
            ...
            <li>Secure password policies and regular security training</li>
          </ul>
        ...
        <section>
          ...
          <div class="space-y-4">
            ...
            <div>
              <h3 class="text-lg font-semibold text-gray-900 mb-2">Access</h3>
              <p>
            ...
            <div>
              ...
              <p>
                You have the right to receive your information in a portable
                format.
              </p>
            </div>
            ...
            <p class="text-sm text-gray-600 mt-4">
              ...
              <a
                href="mailto:privacy@mintedu.com"
                class="text-emerald-600 hover:text-emerald-700"
                >privacy@mintedu.com</a
              >
            </p>
          </div>
        </section>
        ...
        <section>
          ...
          <p>
            MintEdu does not knowingly collect personal information from
            children under 13. If we become aware that we have collected
            personal information from a child under 13, we will promptly delete
            such information and terminate the child's account. If you believe
        ...
        <section>
          ...
          <p>
            ...
            settings. However, disabling cookies may affect functionality of our
            platform.
          </p>
          <p class="mt-4">We use cookies for:</p>
        ...
        <section>
          ...
          <p>
            MintEdu operates on the Hedera network. Transaction data, including
            loan amounts, investor information, and payment history, may be
            recorded on the public blockchain. While personal identifying
            information is not directly stored on the blockchain, transaction
            activity may be traceable through wallet addresses.
          </p>
          <p class="mt-4">
            Please understand that blockchain transactions are immutable and
            permanent. Exercise caution when reviewing what information you
            connect to your wallet addresses.
          </p>
        </section>
        ...
        <section>
          ...
          <p>
            ...
            Policy, unless a longer retention period is required by law. When
        ...
        <section>
          ...
          <p>
            ...
            have different data protection laws. By using MintEdu, you consent
        ...
        <section>
          ...
          >
            <p class="font-semibold text-gray-900">MintEdu Privacy Team</p>
        ...
        <section>
          ...
          <p>
            ...
            you of any material changes by updating the "Last Updated" date at
            the top of this policy. Your continued use of MintEdu after changes
